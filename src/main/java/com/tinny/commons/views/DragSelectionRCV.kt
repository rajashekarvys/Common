...
import com.tinny.commons.interfaces.RecyclerScrollCallback

class DragSelectionRCV: RecyclerView {
    ...
    init {
        ...
        if (layoutManager is androidx.recyclerview.widget.LinearLayoutManager) {
            linearLayoutManager = layoutManager as androidx.recyclerview.widget.LinearLayoutManager
        }
